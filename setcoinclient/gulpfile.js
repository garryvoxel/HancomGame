...
// build dist path
var destPath = 'public/coinpile_sample';
var envType = '';
...
gulp.task('watch', function() {
  gulp.watch('WebContent/**/*.js', gulp.series([copyJs]));
})
...
gulp.task('dev-build', gulp.series([setEnvDev, copyConf, copyJs, copy, copyWebContent, 'watch']));
