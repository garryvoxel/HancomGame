 ...
 */
function BackObjPelican2V1(aGame, aX, aY, aKey, aFrame) {
...
/** @type Phaser.Sprite */
var BackObjPelican2V1_proto = Object.create(Phaser.Sprite.prototype);
BackObjPelican2V1.prototype = BackObjPelican2V1_proto;
BackObjPelican2V1.prototype.constructor = BackObjPelican2V1;

/* --- end generated code --- */
// -- user code here --
BackObjPelican2V1.prototype.beforeCreate = function() {
	
};

BackObjPelican2V1.prototype.afterCreate = function() {	
	this.tweenA = null;
	this.isTween = false;
	this.dir = 1;
...
BackObjPelican2V1.prototype.setPlay = function(aAnimaitonName, aIsTween, aDir) {	
	...
	//console.log("BackObjPelican2V1 aAnimaitonName is " + aAnimaitonName);
};

BackObjPelican2V1.prototype.update = function () {
	//기존함수테스트
	this.gameProcess();	
};

BackObjPelican2V1.prototype.gameProcess = function(){	
	this.processCharacter();
	this.animationOnComplete();
};

BackObjPelican2V1.prototype.processCharacter = function(){	
	this.nowCnt++;
	if(this.nowCnt % 20 === 0){
...
BackObjPelican2V1.prototype.animationOnComplete = function(){	
...
//트윈은 있는 동작만 추가한다.
BackObjPelican2V1.prototype.playTweenBasic = function(){
...
BackObjPelican2V1.prototype.endTweenPlay = function(){	
