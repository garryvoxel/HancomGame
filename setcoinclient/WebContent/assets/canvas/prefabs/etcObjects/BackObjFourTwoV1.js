 ...
 */
function BackObjFourTwoV1(aGame, aX, aY, aKey, aFrame) {
...
/** @type Phaser.Sprite */
var BackObjFourTwoV1_proto = Object.create(Phaser.Sprite.prototype);
BackObjFourTwoV1.prototype = BackObjFourTwoV1_proto;
BackObjFourTwoV1.prototype.constructor = BackObjFourTwoV1;

/* --- end generated code --- */
// -- user code here --
BackObjFourTwoV1.prototype.beforeCreate = function(){
	
};

BackObjFourTwoV1.prototype.afterCreate = function() {	
	this.tweenA = null;
	this.isTween = false;
	this.dir = -1;
...
BackObjFourTwoV1.prototype.setPlay = function(aAnimaitonName, aIsTween, aDir) {	
	...
	//console.log("BackObjFourTwoV1 aAnimaitonName is " + aAnimaitonName);
};

BackObjFourTwoV1.prototype.update = function () {
	//기존함수테스트
	this.gameProcess();	
};

BackObjFourTwoV1.prototype.gameProcess = function(){	
	this.processCharacter();
	this.animationOnComplete();
};

BackObjFourTwoV1.prototype.processCharacter = function(){	
	this.nowCnt++;
	if(this.nowCnt % 20 === 0)	{
...
BackObjFourTwoV1.prototype.animationOnComplete = function(){	
...
//트윈은 있는 동작만 추가한다.
BackObjFourTwoV1.prototype.playTweenBasic = function(){
...
BackObjFourTwoV1.prototype.endTweenPlay = function(){	
