<template>
    <div class="page-container">
        ...
        <statistics-stat-retain-bygame v-if="isCurrentPage('/typing/statistics/stat-retain-bygame')" />
...
import StatisticsStatRetainByGame from '@/components/StatisticsStatRetainByGame.vue';

export default {
    name: "stat-retain-bygame",
    components: {
        'main-menu': MainMenu
        ,'statistics-stat-retain-bygame': StatisticsStatRetainByGame
    },
    methods: {
        isCurrentPage(page) {
            const
