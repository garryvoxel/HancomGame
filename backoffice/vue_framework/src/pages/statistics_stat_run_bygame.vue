<template>
    <div class="page-container">
        ...
        <statistics-run-bygame v-if="isCurrentPage('/typing/statistics/stat-run-bygame')" />
...
import StatisticsStatRunBygame from '@/components/StatisticsStatRunBygame.vue';

export default {
    name: "stat-run-bygame",
    components: {
        'main-menu': MainMenu
        ,'statistics-run-bygame': StatisticsStatRunBygame
    },
    methods: {
        isCurrentPage(page) {
            const
