<template>
    <div class="page-container">
        ...
        <statistics-stat-daumau v-if="isCurrentPage('/typing/statistics/dau-mau')" />
...
import StatisticsStatDAUMAU from '@/components/StatisticsStatDAUMAU.vue';

export default {
    name: "stat-daumau",
    components: {
        'main-menu': MainMenu
        ,'statistics-stat-daumau': StatisticsStatDAUMAU
    },
    methods: {
        isCurrentPage(page) {
            const
