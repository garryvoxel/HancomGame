<template>
    <div class="page-container">
        ...
        <statistics-stat-daumau-bygame v-if="isCurrentPage('/typing/statistics/stat-daumau-bygame')" />
...
import StatisticsStatDAUMAUByGame from '@/components/StatisticsStatDAUMAUByGame.vue';

export default {
    name: "stat-daumau-bygame",
    components: {
        'main-menu': MainMenu
        ,'statistics-stat-daumau-bygame': StatisticsStatDAUMAUByGame
    },
    methods: {
        isCurrentPage(page) {
            const
