<template>
    <div class="page-container">
        ...
        <service-ranking-list v-if="isCurrentPage('/typing/service/ranking/list')" />
...
import ServiceRankingList from '@/components/ServiceRankingList.vue';

export default {
    name: "ranking",
    components: {
        'main-menu': MainMenu
        ,'service-ranking-list': ServiceRankingList
    },
    methods: {
        isCurrentPage(page) {
            const
