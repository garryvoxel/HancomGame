<template>
    <div class="page-container">
        ...
        <statistics-stat-login v-if="isCurrentPage('/typing/statistics/stat-login')" />
...
import StatisticsStatlogin from '@/components/StatisticsStatlogin.vue';

export default {
    name: "stat-login",
    components: {
        'main-menu': MainMenu
        ,'statistics-stat-login': StatisticsStatlogin
    },
    methods: {
        isCurrentPage(page) {
            const
