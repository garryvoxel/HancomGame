<template>
    <div class="page-container">
        ...
        <statistics-stat-menu v-if="isCurrentPage('/typing/statistics/stat-bymenu')" />
...
import StatisticsStatMenu from '@/components/StatisticsStatBymenu.vue';

export default {
    name: "stat-bymenu",
    components: {
        'main-menu': MainMenu
        ,'statistics-stat-menu': StatisticsStatMenu
    },
    methods: {
        isCurrentPage(page) {
            const
