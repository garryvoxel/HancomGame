                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 낱말연습통계
                            </h4>
                        </div>
                    </div>
                </div>
    ...
    methods:{
        ...
        csvDownload(target){
            ...
            switch(target){
                ...
                break;
                case 'byLevel' :  
                    csvContent = "No,level1,level2,level3,level4,level5,level6,level7,level8\n";
                    csvContent += [
