                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 게임별 DAU / MAU
                            </h4>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-12 form-row text-left">
                                            <div class="col-sm-4 my-1">
                                                <span class="dset" style="border:0">
                                                    <select class="form-control" v-model="selectedGame" @change="getDAUMAU">
                                        ...
                                        <div class="tablewrap">
                                            ...
                                            <table class="tbsty01 text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="selectedGame != '' && mauStatList.length === 0 ">
                                                        <td  colspan="6"> 등록된 로그가 없습니다. </td>
                                                    </tr>
                                                    <tr v-if=" selectedGame == '' ">
                                                        <td  colspan="6"> 게임을 선택해 주세요 </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('game-dau')"><i class="fa fa-download"></i> 다운로드</button>
                                    </div>
                                </div>
                                <!-- data table end -->
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="data-tables">
                                        ...
                                        <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('game-mau')"><i class="fa fa-download"></i> 다운로드</button>
                                    </div>
                                </div>
                                <!-- data table end -->
                            </div>
...
export default {
    ...
    methods:{
                    ...
                    if (typeof response == "undefined") {
                        ...
                        switch (response.data.code) {
                            ...
                            case ResponseCode.OK.code:
                                ...
                                if(this.selectedGame != '')  this.getDAU();
                                break;
        ...
        getYList(){
            ...
            if(this.selectedGame != '') this.getMAU();        
        },
        dateFormat(datetime) {
        ...
        getDAU(){
            let _url = "/typing/api/statistics/stat-game-dau?yearmonth="+this.selectedYearMonth+"&game="+this.selectedGame;
            //alert('일별:::'+_url);
        ...
        getMAU(){
            let _url = "/typing/api/statistics/stat-game-mau?year="+this.selectedYear+"&game="+this.selectedGame;
            //alert('월별:::'+_url);
