                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 게임별 실행 수
                            </h4>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods:{
        ...
        getDailyStatList(){
            this.isLoading = true;
            let _url = "/typing/api/statistics/stat-start-bygame-daily?gamecode="+this.selectedGame+"&yearmonth="+this.selectedYearMonth;
            //alert('일별:::'+_url);
        ...
        getWeeklyStatList(){
            ...
            let _url = "/typing/api/statistics/stat-start-bygame-weekily?gamecode="+this.selectedGame+"&week="+this.selectedWeek
        ...
        getMonthlyStatList(){
            this.isLoading = true;
            let _url = "/typing/api/statistics/stat-start-bygame-monthly?gamecode="+this.selectedGame+"&year="+this.selectedYear;
            //alert('월별:::'+_url);
