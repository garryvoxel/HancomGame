                    ...
                    <div class="data-tables">
                        ...
                        <div class="tablewrap mt-2">
                            <table class="tbsty01 text-center">
                                ...
                                <tbody>
                                    <tr v-for="(forum,index) in forumlist" v-on:click.prevent="gotoDetail(forum.id)" >
...
export default {
    ...
    methods: {
        getForumList() {
            let url =
                "/typing/api/service/forum-report-comment/list?" +
        ...
        gotoDetail(id) {
            window.location.href = "/typing/service/forum-report-comment/" + id + "/detail";
        },
        gotoCreate() {
