                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 공지사항 작성
                            </h4>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        doUploadImage(){
            ...
            let filename = this.$refs.attachImage.files[0].name;
            let _lastDot = filename.lastIndexOf('.');
            let _fileExt = filename.substring(_lastDot, filename.length).toLowerCase();
            if(_fileExt != '.jpg' && _fileExt != '.gif' && _fileExt != '.png' ) { alert('png | jpg | gif 만 첨부가 가능합니다.'); return; };
        ...
        goToWrite() {
            ...
            this.$axios
                .put("/typing/api/service/news/write", {
...
*/
    ...
    mounted() {
        this.tempId = this.tempIdGenerate(20);
        //this.tempId = 't4zp9iw345jst9rh2hl3';
        this.renewImageList();
