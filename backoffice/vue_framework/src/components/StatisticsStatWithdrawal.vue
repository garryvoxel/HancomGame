                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 탈퇴 회원 통계
                            </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <div class="data-tables">
                        ...
                        <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('secession')"><i class="fa fa-download"></i> 다운로드</button>
                    </div>
                </div>
                <!-- data table end -->
            </div>
...
export default {
    ...
    methods:{
        ...
        getDailyStatList(){
            ...
            let _url = "/typing/api/statistics/stat-withdrawal-daily?yearmonth="+this.selectedYearMonth;
            this.$axios
                .get(_url)
                .then(response=>{
                    if (typeof response == "undefined") {
        ...
        getWeeklyStatList(){
            ...
            let _url = "/typing/api/statistics/stat-withdrawal-weekly?week="+this.selectedWeek
        ...
        getMonthlyStatList(){
            ...
            let _url = "/typing/api/statistics/stat-withdrawal-monthly?year="+this.selectedYear;
            this.$axios
                .get(_url)
                .then(response=>{
                    if (typeof response == "undefined") {
