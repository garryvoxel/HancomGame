                                        ...
                                        <td>
                                            <div class="col-sm-2">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" :value="forumInfo.reports">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-row align-items-center pl-3">
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" value="//TODO:신고자가 다수일경우 표현...">
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                    <button
...
export default {
    ...
    methods: {
        ...
        getForumInfo(){
            this.$axios
                .get('/typing/api/service/forum-report-post/'+this.id+'/info')
                .then( response => {
                    if (typeof response == "undefined") {
                        ...
                        switch (response.data.code) {
                            ...
                            case ResponseCode.OK.code:
                                ...
                                this.reportsList  = response.data.result.reportsList;
                            ...
                            default:
                                alert(
                                    "자유게시판-원글 신고글 정보를 가져오느데 실패 했습니다.\n다시 시도해 주세요.\n"
