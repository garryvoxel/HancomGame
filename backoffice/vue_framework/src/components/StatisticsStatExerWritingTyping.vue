        ...
        <div class="main-content-inner">
                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 긴글연습통계
                            </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link "  v-bind:class="[tabController == 'u' ? 'active':'']" id="using-tab" data-toggle="tab" href="#using-info" role="tab"  aria-selected="false">사용횟수</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:class="[tabController == 'c' ? 'active':'']" id="clear-tab" data-toggle="tab" href="#clear-info" role="tab" aria-selected="false">클리어 횟수</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:class="[tabController == 'p' ? 'active':'']" id="playtime-tab" data-toggle="tab" href="#playtime-info" role="tab" aria-selected="false">평균 플레이 타임</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:class="[tabController == 'v' ? 'active':'']" id="verify-tab" data-toggle="tab" href="#verify-info" role="tab" aria-selected="false">타자검증 이용횟수</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:class="[tabController == 's' ? 'active':'']" id="sentence-tab" data-toggle="tab" href="#sentence-info" role="tab" aria-selected="false">문장별 사용횟수</a>
                    </li>
                </ul>
                <!-- tab-content 시작 -->
                <div class="tab-content mt-2" id="myTabContent">
                    <!-- 사용 정보 탭 시작 -->
                    <div class="tab-pane fade " v-bind:class="[tabController == 'u' ? 'active show':'']" id="using-info" role="tabpanel" >
                        <!-- class row 시작 -->
                        <div class="row">
                            <!-- data table start -->
                            <div class="col-12">
                                <div class="data-tables">
                                    <div class="tablewrap mt-2">
                                        <table class="tbsty01 text-center">
                                            ...
                                            <tbody>
                                                <tr v-for="(stat, index) in statListByUsing">
                    ...
                    <!-- 클리어횟수 탭 시작 -->
                    <div class="tab-pane fade" v-bind:class="[tabController == 'c' ? 'active show':'']" id="clear-info" role="tabpanel">
                        <!-- class row 시작 -->
                        <div class="row">
                            <!-- data table start -->
                            <div class="col-12">
                                <div class="data-tables">
                                    <div class="tablewrap mt-2">
                                        <table class="tbsty01 text-center">
                                            ...
                                            <tbody>
                                                <tr v-for="(stat, index) in statListByClear">
                                                    <td style="border-right:1px #ccc solid">
                                                        {{stat.m}}
                                                    </td>
                                                    <td style="border-right:1px #ccc solid">
                                    ...
                                    <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('byClear')"><i class="fa fa-download"></i> 다운로드</button>
                                </div>
                            </div>
                            <!-- data table end -->
                        </div> 
                    ...
                    <!-- 플레이타임 탭 시작 -->
                    <div class="tab-pane fade" v-bind:class="[tabController == 'p' ? 'active show':'']" id="playtime-info" role="tabpanel">
                        <!-- class row 시작 -->
                        <div class="row">
                            <!-- data table start -->
                            <div class="col-12">
                                <div class="data-tables">
                                    <div class="tablewrap mt-2">
                                        <table class="tbsty01 text-center">
                                            ...
                                            <tbody>
                                                <tr v-for="(stat, index) in statListByPlayTime">
                                                    <td style="border-right:1px #ccc solid">
                                                        {{stat.m}}
                                                    </td>
                                                    <td style="border-right:1px #ccc solid">
                                    ...
                                    <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('byPlaytime')"><i class="fa fa-download"></i> 다운로드</button>
                                </div>
                            </div>
                            <!-- data table end -->
                        </div> 
                    ...
                    <!-- 타자검증 이용횟수 탭 시작 -->
                    <div class="tab-pane fade" v-bind:class="[tabController == 'v' ? 'active show':'']" id="verify-info" role="tabpanel">
                        <!-- class row 시작 -->
                        <div class="row">
                            <!-- data table start -->
                            <div class="col-12">
                                <div class="data-tables">
                                    ...
                                    <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('byVerify')"><i class="fa fa-download"></i> 다운로드</button>
                                </div>
                            </div>
                            <!-- data table end -->
                        </div> 
                    ...
                    <!-- 문장별 사용횟수 탭 시작 -->
                    <div class="tab-pane fade" v-bind:class="[tabController == 's' ? 'active show':'']" id="sentence-info" role="tabpanel">
                        <!-- class row 시작 -->
                        <div class="row">
                            <!-- data table start -->
                            <div class="col-12">
                                <div class="data-tables">
                                    <div class="tablewrap mt-2">
                                        <table class="tbsty01 text-center">
                                            ...
                                            <tbody>
                                                <tr v-for="(stat, index) in statListBySentence">
                                                    <td style="border-right:1px #ccc solid">
                                                        {{stat.sentence_idx}}
                                                    </td>
                                                    <td style="border-right:1px #ccc solid">
                                    ...
                                    <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('bySentence')"><i class="fa fa-download"></i> 다운로드</button>
                                </div>
                            </div>
                            <!-- data table end -->
                        </div> 
        ...
        getStat(){
            ...
            switch(this.selectedOption) {
                case 'daily' : 
                    ...
                    _url = "/typing/api/statistics/stat-ewrt-daily?";
                    break;
                case 'weekly' : 
                    ...
                    _url = "/typing/api/statistics/stat-ewrt-weekly?";
                break;
                case 'monthly' : 
                    get_param = 'type=monthly&yearmonth='+this.selectedYearMonth;
                    _url = "/typing/api/statistics/stat-ewrt-monthly?";
                    break;                
                default :
                    ...
                    if (typeof response == "undefined") {
                        ...
                        switch (response.data.code) {
                            ...
                            case ResponseCode.OK.code:
                                ...
                                this.statListByUsing = response.data.result.usingLog;
                                this.statListByClear = response.data.result.byClear;
                                this.statListByPlayTime = response.data.result.byPlaytime;
                                this.statListBySentence = response.data.result.bySentence;
                                break;
        ...
        csvDownload(target){
            ...
            switch(target){
                case 'byUsing' :  
                    csvContent = "No,사용 횟수\n";
                    csvContent += [
                        ...this.statListByUsing.map(item => Object.values(item).join(","))
                    ]
                        .join("\n")
                        .replace(/(^\[)|(\]$)/gm, "");
                ...
                break;
                case 'byClear' :  
                    csvContent = "No,클리어 횟수\n";
                    csvContent += [
                        ...this.statListByClear.map(item => Object.values(item).join(","))
                    ]
                        .join("\n")
                        .replace(/(^\[)|(\]$)/gm, "");
                    //const murl = window.URL.createObjectURL(new Blob([csvContent]));
                    const curl = window.URL.createObjectURL(new Blob(["\ufeff"+csvContent], {type: 'text/csv;charset=utf-8;'}));
                    const clink = document.createElement('a');
                    clink.href = curl;
                    clink.setAttribute('download', filename);         
                    document.body.appendChild(clink); 
                    clink.click();                
                break;
                case 'byPlaytime' :  
                    csvContent = "No,평균 플레이 시간\n";
                    csvContent += [
                        ...this.statListByPlayTime.map(item => Object.values(item).join(","))
                    ]
                        .join("\n")
                        .replace(/(^\[)|(\]$)/gm, "");
                    //const murl = window.URL.createObjectURL(new Blob([csvContent]));
                    const purl = window.URL.createObjectURL(new Blob(["\ufeff"+csvContent], {type: 'text/csv;charset=utf-8;'}));
                    const plink = document.createElement('a');
                    plink.href = purl;
                    plink.setAttribute('download', filename);         
                ...
                case 'byVerify' :  
                    ...
                    csvContent += [
                        ...
                        .replace(/(^\[)|(\]$)/gm, "");
                    //const murl = window.URL.createObjectURL(new Blob([csvContent]));
                    const vurl = window.URL.createObjectURL(new Blob(["\ufeff"+csvContent], {type: 'text/csv;charset=utf-8;'}));
                ...
                case 'bySentence' :  
                    csvContent = "No,사용횟수\n";
                    csvContent += [
                        ...this.statListBySentence.map(item => Object.values(item).join(","))
                    ]
                        .join("\n")
                        .replace(/(^\[)|(\]$)/gm, "");
                    //const murl = window.URL.createObjectURL(new Blob([csvContent]));
                    const surl = window.URL.createObjectURL(new Blob(["\ufeff"+csvContent], {type: 'text/csv;charset=utf-8;'}));
