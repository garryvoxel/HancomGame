                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 게임별 Retention Rate
                            </h4>
                        </div>
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="col-12 text-left">
                                        <span class="dset" style="border:0">
                                            <select class="form-control" v-model="selectedGame" @change="getStatRetainByGame('daily')">
                                ...
                                <td>
                                    <div class="col-12 text-left">
                                        ...
                                        <span class="dset" style="border:0" v-if="selectedOption =='hourly' || selectedOption =='daily'">
                                            <select class="form-control" v-model="selectedDay" @change="getStatRetainByGame('daily')">
                        ...
                        <div class="tablewrap mt-2">
                            <table class="tbsty01 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="selectedGame != '' && statList.length == 0">
                                        <td colspan='4'>
                                            로그데이터가 없습니다.
                                        </td>
                                    </tr>
...
export default {
    ...
    methods:{
        ...
        getStatRetainByGame(type){
            ...
            let _url = "/typing/api/statistics/stat-retain-bygame?"+get_param+"&game="+this.selectedGame;
            this.$axios
                .get(_url)
                .then(response=>{
