        ...
        <div class="main-content-inner">
                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="spage-title pull-left">
                                <i class="ti-control-play"></i> 짧은글연습통계
                            </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" v-bind:class="[tabController == 'f' ? 'active':'']" id="mobile-tab" data-toggle="tab" href="#mobile-info" role="tab" aria-selected="false">평균 플레이 타임</a>
                    </li>
                </ul>
                <!-- tab-content 시작 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="data-tables">
                                    ...
                                    <button class="btn btn-default btn-success mt-3" @click.prevent="csvDownload('byTime')"><i class="fa fa-download"></i> 다운로드</button>
                                </div>
                            </div>
                            <!-- data table end -->
                        </div> 
