                    ...
                    <div class="data-tables">
                        ...
                        <div class="tablewrap mt-2">
                            <table class="tbsty01 text-center">
                                ...
                                <tbody>
                                    <tr v-for="(faq,index) in faqlist" @click="goToDetail(faq.id)">
                                    ...
                                    <tr v-if="faqlist.length === 0">
						                <td colspan="5" class="clan-empty">등록된 FAQ가 없습니다.</td>
						            </tr>
                                </tbody>
                            </table>
                        </div>
...
export default {
    ...
    methods: {
        goToWrite() {
            window.location.href = "/typing/service/faq/write";
        },
        getNewsList() {
            let url =
                "/typing/api/service/faq/list?" +
                    ...
                    if (typeof response == "undefined") {
                        ...
                        switch(response.data.code) {
                            ...
                            case ResponseCode.OK.code :
                                //alert(JSON.stringify(response.data.result.rows));
                                ...
                                this.faqlist =          response.data.result.rows;
        ...
        goToDetail(id) {
            window.location.href = "/typing/service/faq/" + id + "/detail";
        },
        dateFormat(datetime) {
