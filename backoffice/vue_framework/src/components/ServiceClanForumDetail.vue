            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="col-12 text-center mt-5">
                        ...
                        <button v-on:click.prevent="doRelive" class="btn btn-flat btn-secondary" v-if="forumInfo.deleted_at != null">해당 게시물 복원</button>
...
export default {
    ...
    methods: {
        goBack() {
            ...
            window.location.href="/typing/service/clan/"+searchValue.clan_id+"/detail?q="+this.$route.query.q;

        },
        getForumInfo(){
            this.$axios
                .get('/typing/api/service/forumclan/'+this.id+'/info')
                .then( response => {
                    //alert(JSON.stringify(response.data.result.forumInfo));
        ...
        doDelete(){
            if(confirm('해당글을 삭제 처리 하시겠습니까?')){
                this.$axios
                .post('/typing/api/service/forumclan/delete',{
                    id: this.id
                })
                .then(response=>{
                    ...
                    if (typeof response == "undefined") {
                        ...
                        switch (response.data.code) {
                            ...
                            case ResponseCode.OK.code:
                                alert('글이 삭제되었습니다.');
                                //window.location.href='/typing/service/clan/'+this.id+'/detail';
                                this.getForumInfo();
                                break;
        ...
        doRelive(){
            if(confirm('삭제된 글을 복원처리 하시겠습니까?')){
                this.$axios
                .post('/typing/api/service/forumclan/relive',{
                    id: this.id
                })
                .then(response=>{
        ...
        doDeleteComment(comment_id){
            if(confirm('해당 댓글을 삭제 처리 하시겠습니까?')) {
                this.$axios
                .post('/typing/api/service/forum-clan-comment/dodelete',{
                    id: comment_id
                })
                .then(response=>{
        ...
        doReliveComment(comment_id){
            if(confirm('해당 댓글을 다시 살리시겠습니까?')) {
                this.$axios
                .post('/typing/api/service/forum-clan-comment/dorelive',{
                    id: comment_id
                })
                .then(response=>{
