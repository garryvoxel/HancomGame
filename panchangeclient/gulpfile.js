...
function copyAssets() {
  return gulp.src([
    ...
    'WebContent/assets/**/*.ttf',
    'WebContent/assets/**/*.woff',
...
gulp.task('watch', function() {
  gulp.watch('WebContent/**/*.js', gulp.series([copyJs, copyAssets]));
})
...
function setEnvTst() {
  ...
  .pipe(gulp.dest(destPath+'/WebContent/js'));
}
...
gulp.task('tst-build', gulp.series([setEnvTst, copyConf, copyJs, copy, copyWebContent, copyAssets]));
gulp.task('dev-build', gulp.series([setEnvDev, copyConf, copyJs, copy, copyWebContent, copyAssets, 'watch']));
