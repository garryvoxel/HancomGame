...
.front-modal__chk-input:checked {
  background-image: url('/imgs/event/front_modal_icon_chk.png');
  background-image: -webkit-image-set(
    url('/imgs/event/front_modal_icon_chk.png') 1x,
    url('/imgs/event/front_modal_icon_chk@2x.png') 2x
  );
}
...
.front-modal__btn-close {
  ...
  background-repeat: no-repeat;
  background-image: url('/imgs/event/front_modal_btn_close.png');
  background-image: -webkit-image-set(
    url('/imgs/event/front_modal_btn_close.png') 1x,
    url('/imgs/event/front_modal_btn_close@2x.png') 2x
  );
