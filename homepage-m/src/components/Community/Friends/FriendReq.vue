            ...
            <section class="main-content">
                ...
                <div class="sub-wrap p-3">
                    <ul class="nav-tabs1">
                        ...
                        <li class="current"><router-link to="/friends/req"><div>받은<br>친구요청 <span>{{friendRequestsReceived.length}}</span></div></router-link></li>
                    ...
                    <div id="tab1" class="tabcontent current">
                        <ul class="friends-list">
                            <li class="friends-item"
                                ...
                                v-for="friendReq in friendRequestsReceived"
                            >
                                <div class="friends-thumbnail">
                                    <avatar-image
                                        class="friends-image"
                                        :index="friendReq.avatar"
                                    />
                                </div>
                                <div class="friends-info">
                                    <p class="nick">닉네임 : <span>{{friendReq.nickname}}</span></p>
                                    <p class="lv">소속 클랜 : <span>{{friendReq.clan ? friendReq.clan : "클랜 없음"}}</span></p>
                                </div>
                                <div class="friends-btn">
                                    <button class="btn btn-primary btn-xs" @click="acceptFriendRequest(friendReq.nickname)">수락</button>
                                    <button class="btn btn-secondary btn-xs" @click="deleteFriendRequestReceived(friendReq.nickname)">거절</button> 
                                </div>
                                
                            </li>
                            <li class="friends-item friends-item-empty" v-if="friendRequestsReceived.length <= 0">
...
export default {
    ...
    methods: {
        ...
        deleteFriendRequestReceived(nickname) {
            if (
